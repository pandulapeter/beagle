...
import com.pandulapeter.beagle.core.databinding.BeagleCellSectionHeaderBinding
...
internal data class SectionHeaderCell(
    ...
    override fun createViewHolderDelegate() = object : ViewHolder.Delegate<SectionHeaderCell>() {
        ...
        override fun createViewHolder(parent: ViewGroup) = TextViewHolder(
            binding = BeagleCellSectionHeaderBinding.inflate(parent.inflater, parent, false)
        )
    }

    private class TextViewHolder(
        private val binding: BeagleCellSectionHeaderBinding
    ) : ViewHolder<SectionHeaderCell>(binding.root) {
        ...
        override fun bind(model: SectionHeaderCell) = binding.beagleTextView.run {
            setText(model.text)
