...
**Note: The app is not yet published, the link doesn't work yet.**
...
dependencies {
    …
    def beagleVersion = "2.0.0-alpha08"
...
Check out [the showcase app](https://play.google.com/store/apps/details?id=com.pandulapeter.beagleExample) for some ideas on what is possible with the built-in modules or for a playground tool which can be used to preview and generate code for any module configuration.
