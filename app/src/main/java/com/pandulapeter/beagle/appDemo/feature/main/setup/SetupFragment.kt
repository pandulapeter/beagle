...
import com.pandulapeter.beagle.appDemo.databinding.FragmentSetupBinding
...
class SetupFragment : DestinationFragment<FragmentSetupBinding, SetupViewModel>(R.layout.fragment_setup, R.string.setup_title) {
