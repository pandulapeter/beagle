...
sealed class BundleArgumentDelegate<T>(protected val key: kotlin.String, protected val defaultValue: T) : ReadWriteProperty<Bundle?, T> {
    ...
    class Parcelable<T : android.os.Parcelable>(key: kotlin.String, defaultValue: T? = null) : BundleArgumentDelegate<T?>(key, defaultValue) {
    ...
    class ParcelableList<T : android.os.Parcelable>(key: kotlin.String, defaultValue: List<T> = emptyList()) : BundleArgumentDelegate<List<T>>(key, defaultValue) {
