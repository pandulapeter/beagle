...
internal data class ExpandedItemCheckBoxCell(
    ...
    private class CheckBoxViewHolder(parent: ViewGroup) : ViewHolder<ExpandedItemCheckBoxCell>(LayoutInflater.from(parent.context).inflate(R.layout.beagle_cell_expanded_item_check_box, parent, false)) {
