...
internal data class ExpandedItemKeyValueCell(
    ...
    private class KeyValueViewHolder(parent: ViewGroup) : ViewHolder<ExpandedItemKeyValueCell>(LayoutInflater.from(parent.context).inflate(R.layout.beagle_cell_expanded_item_text, parent, false)) {
