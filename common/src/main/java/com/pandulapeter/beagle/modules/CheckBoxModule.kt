 ...
 * @param initialValue - Whether or not the checkbox is checked initially. Optional, false by default. If [isPersisted] is true, the value coming from the local storage will override this parameter so it will only be used the first time the app is launched.
