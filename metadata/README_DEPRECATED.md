...
While there are no migration steps, upgrading to the new API as if you were implementing it for the first time should not take long. [click here](https://github.com/pandulapeter/beagle/blob/master/README.md) to see the updated readme file.
...
### Screenshots
<img src="metadata/screenshot01.png" width="30%" /> <img src="metadata/screenshot02.png" width="30%" />
